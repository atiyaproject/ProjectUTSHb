...
public class MainVeganAdmin extends Activity{
	private String TAG = MainVeganAdmin.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnNew.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent iNew = new Intent(MainVeganAdmin.this, Beauty_AddAct.class);
				finish();
				startActivity(iNew);
			}
		});
		...
		listView.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View v,
				...
				final ArrayAdapter<String> adapter = new ArrayAdapter<String>(
						MainVeganAdmin.this, android.R.layout.simple_list_item_1,
						arrayItem);
						...
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								if (adapter.getItem(positionDialog).equals(Static.UPDATE)) {
									Intent iEdit = new Intent(MainVeganAdmin.this,EditBeauty.class);
	...
	private class GetBeauty extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			pDialog = new ProgressDialog(MainVeganAdmin.this);
	...
	private class Deletebeautytalk extends AsyncTask<entity_beauty_talk, Void, String> {
		...
		protected void onPostExecute(String result) {
			...
			if (result.equals(Static.SUCCESS)) {
				Toast.makeText(MainVeganAdmin.this, "BeautyTalk deleted",
						Toast.LENGTH_LONG).show();
				listbeauty.clear();
				new GetBeauty().execute();
			} else if (result.equals(Static.FAIL)) {

				Toast.makeText(MainVeganAdmin.this, "Fail to delete beautytalk",
						Toast.LENGTH_LONG).show();
			}
		}
	}
	...
	public void onBackPressed() {
		Intent i = new Intent(MainVeganAdmin.this, MainAdmin_MenuUtama.class);
		finish();
		startActivity(i);
	}
}